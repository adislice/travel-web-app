...
const PaketWisataPage = () => {
  const [loading, setLoadinh] = useState(false)
  ...
  return (
    <AdminLayout>
      ...
      <h3 className='p-5 text-2xl text-gray-800 font-semibold'>Paket Wisata</h3>
      <div className="wrapper px-5">
        <div className="actionbutton space-x-2 flex flex-row mb-4">
          <Button color="dark" type='submit' className='rounded-md' size="sm">
            Tambah
          </Button>
              ...
              {datas.map((item, index) => (
                <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                  ...
                  <td className="px-4 py-4">
                    ...
                    <Href href={'/admin/paketwisata/' + item.id} className="text-gray-900">
                    {item.nama}
                    </Href>
