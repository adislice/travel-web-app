      ...
      <div className="wrapper">
        <FormProvider {...methods}>
          <form
            ...
            className="md:p-4 rounded-xl mb-5 bg-white"
          >
            <h3 className="pt-3 px-4 text-lg font-semibold text-gray-800">
              Detail
            </h3>
            <div className="relative overflow-x-auto flex flex-wrap">
              ...
              <div id="kanan" className="w-full md:w-1/2 p-4 ">
                <div className="mb-2 block">
                  <div className="text-sm font-medium text-gray-900 dark:text-gray-300 mb-2 inline-block">
                    Gambar
                  </div>
                  <ImageUpload>
        ...
        <div className="md:p-4 rounded-xl bg-white">
          <div className="mb-4 block">
            <div className="flex flex-row items-center">
              <h3 className="py-3 px-4 text-lg font-semibold text-gray-800">
              ...
              >
                <Icons.tambah className="h-4 w-4 mr-1.5" />
                Pilih Tempat Wisata
              </button>
            </div>
                      ...
                      >
                        <td className="w-11">
                          <img
                            ...
                            alt={item.nama}
                            className="mx-auto w-12 h-12 my-2 object-cover rounded"
                          />
                        </td>
              ...
              <div className="flex flex-col gap-2" onChange={onChangeRadio}>
                {dataTempatWisata.map((item, index) => (
                  <label
                    key={`tw-${index}`}
                    htmlFor={`tw-${item.id}`}
                    className="flex flex-row items-center label-custom relative"
                  >
                    <input
                      type="radio"
                      name="pilih-tw"
